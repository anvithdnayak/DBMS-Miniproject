...
<html>
    <head>
        <title>Purple Line Time Table</title>
        <style>
            .topnav {
...
<center><h2><u>WEEKDAYS</u></h2></center>
    <table bgcolor="AAA6FF" align="center" border="2" height=500, width=1000>
        <tr><th>FROM
            <th>TO
            <th>FREQUENCY
        </tr>
        ...
        <?php
            ...
            $query = "SELECT * FROM `time_table_pl_weekdays`";
...
<center><h2><u>WEEKENDS</u></h2></center>
    <table bgcolor="AAA6FF" align="center" border="2" height=500, width=1000>
        ...
        <?php
            ...
            $query = "SELECT * FROM `time_table_pl_weekends`";
            $week = mysqli_query($connect, $query);
            if($week)
            {
                while($record=mysqli_fetch_assoc($week))
